        ...
        <div class="panel-body">
            <form method="POST">
                ...
                <div class="form-group">
                    Are you sure you want to lock the thread <strong>{{ $thread->title }}</strong> by <a href="{{ route('character', $thread->player) }}">{{ $thread->player->name }}</a>?
                </div>

                <input type="submit" value="Lock" class="btn btn-primary">
